 ...
 * re-purpose ContentProvider's interface to use it as a key-value table.
 *
 * Please read:
 *
 ...
 *
 * There are two methods you need to implement---insert() and query(). Others
 * are optional and will not be tested.
 *
 * @author stevko
 *
 */
public class GroupMessengerProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        Cursor cr = dbo.retrievefrom(dbo, selection);
